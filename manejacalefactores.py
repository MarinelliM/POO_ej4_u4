...
from calefactoresgas import CalefactorGas
from calefactoresele import CalefactorElectrico
import csv
...
class ManejadorCalefactor:
    ...
    def __init__(self):
        self.__array = np.empty(0, dtype=calefactores)
    ...
    def CargaCG(self):
        ...
        for fila in reader:
            if bandera:
                ...
                calefactor = calefactoresgas(fila[0], fila[1], fila[2], fila[3])
    ...
    def CargaCE(self):
        ...
        for fila in reader:
            if bandera:
                ...
                calefactor = calefactoresele(fila[0], fila[1], fila[2])
                self.agregarCalefactor(calefactor)
    ...
    def mostrartipo(self,posmin):
        retorna = None
        if type(self.__array[posmin]) is calefactoresele:
